...
public class TUITest {
	...
	public void test() {
		...
		String strCoinTest1 = "|___|_O_|___|___|___|___|___|" + GameController.newline +
							  "|___|_X_|___|___|___|___|___|" + GameController.newline +
							  "|___|_O_|___|___|___|___|___|" + GameController.newline + 
							  "|___|_X_|___|___|___|___|___|" + GameController.newline +
							  "|___|_O_|___|_O_|___|___|___|" + GameController.newline +
							  "|___|_X_|___|_X_|___|___|___|" + GameController.newline;
	...
	public void dropCointTest1() {
		...
		success &= GameController.getInstance().dropCoinWithSuccessFeedback(3);
		success &= GameController.getInstance().dropCoinWithSuccessFeedback(3);
		success &= GameController.getInstance().dropCoinWithSuccessFeedback(1);
		success &= GameController.getInstance().dropCoinWithSuccessFeedback(1);
		success &= GameController.getInstance().dropCoinWithSuccessFeedback(1);
		success &= GameController.getInstance().dropCoinWithSuccessFeedback(1);
		success &= GameController.getInstance().dropCoinWithSuccessFeedback(1);
