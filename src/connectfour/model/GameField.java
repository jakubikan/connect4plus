...
public class GameField implements Cloneable {
    ...
    private void evaluateVertical(final Player playerToCheck, int counters[]) {
        int count = 0;
        for (int row = 0; row < DEFAULT_ROWS; row++) {
            count = 0;
    ...
    private void evaluateHorizontal(final Player playerToCheck, int counters[]) {
        int count = 0;
    ...
    private void evaluateDiagonalFromLeftToRight(final Player playerToCheck, int counters[]) {
        int count = 0;
        for (int row = 0; row < DEFAULT_ROWS - 1; row++) {
            count = 0;
            for (int col = 0; col < DEFAULT_COLUMNS - 1; col++) {
    ...
    private void evaluateDiagonalFromRigthToLeft(final Player playerToCheck, int counters[]) {
        int count = 0;
        for (int row = 0; row < DEFAULT_ROWS - 1; row++) {
            count = 0;
            for (int col = 0; col < DEFAULT_COLUMNS - 1; col++) {
